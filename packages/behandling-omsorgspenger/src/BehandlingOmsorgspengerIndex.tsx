...
const BehandlingOmsorgspengerIndex: FunctionComponent<OwnProps> = ({
  behandlingEventHandler,
  behandlingId,
  ...
  } = restApiOmsorgHooks.useRestApi<ArbeidsgiverOpplysningerWrapper>(
    OmsorgspengerBehandlingApiKeys.ARBEIDSGIVERE,
    {},
    {
