...
const apsAvklarAktiviteter = [{ definisjon: AVKLAR_AKTIVITETER }];
...
describe('<AvklareAktiviteterPanel>', () => {
  ...
  it('skal transform values for avklar aktiviteter aksjonspunkt', () => {
    ...
    const values = {
      avklareAktiviteterListe: [{
        avklarAktiviteter, avklaringsbehov: apsAvklarAktiviteter,
        erTilVurdering: true,
  ...
  it('skal transform values om for valgt overstyring', () => {
    ...
    const values = {
      avklareAktiviteterListe: [{
        avklarAktiviteter, avklaringsbehov: aps, erTilVurdering: true,
        periode: { fom: '2019-02-02', tom: '2019-02-05' }
      }],
      avklarAktiviteter,
    };
