...
const uttak: UttaksplanMedUtsattePerioder = {
  uttaksplan: {
    perioder: {
      ...
      '2021-03-23/2021-03-31': {
        ...
        søkersTapteArbeidstid: 65.11,
        årsaker: [Årsak.FOR_LAV_ØNSKET_UTTAKSGRAD, Årsak.INNGANGSVILKÅR_IKKE_OPPFYLT],
        inngangsvilkår: {
          FP_VK_2: Utfall.OPPFYLT,
          FP_VK_3: Utfall.OPPFYLT,
          K9_VK_1: Utfall.OPPFYLT,
      ...
      '2021-04-02/2021-04-14': {
        ...
        søkersTapteArbeidstid: 65.11,
        årsaker: [Årsak.FOR_MANGE_DAGER_UTENLANDSOPPHOLD],
        inngangsvilkår: {
          FP_VK_2: Utfall.OPPFYLT,
          FP_VK_3: Utfall.OPPFYLT,
          K9_VK_1: Utfall.OPPFYLT,
