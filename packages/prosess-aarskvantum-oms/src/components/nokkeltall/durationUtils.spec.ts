...
describe('durationUtils', () => {
  ...
  it('Konverterer desimaltall til hele dager og timer med maks 2 desimaler', () => {
    const desimal_1 = 9.4;
  ...
  it('Konverterer varighet til dager og timer', () => {
  ...
  it('Konverterer negativt desimaltall eller varighet til dager og timer', () => {
    const desimal = -1.4;
