...
describe('<FaktaBegrunnelseTextField>', () => {
  it('skal ikke vise tekstfelt når en ikke har lov til å løse aksjonspunkt', () => {
    const wrapper = shallow(
      <FaktaBegrunnelseTextField isReadOnly={false} isSubmittable={false} isDirty hasBegrunnelse={false} />,
    );
  ...
  it('skal vise tekstfelt når en har lov til å løse aksjonspunkt og en har gjort endringer', () => {
    const wrapper = shallow(
      <FaktaBegrunnelseTextField isReadOnly={false} isSubmittable isDirty hasBegrunnelse={false} />,
    );
  ...
  it('skal ikke vise label når readOnly', () => {
    const wrapper = shallow(<FaktaBegrunnelseTextField isReadOnly isSubmittable isDirty hasBegrunnelse={false} />);
  ...
  it('skal vise label for vurdering når dette er markert av prop', () => {
    const wrapper = shallow(
      <FaktaBegrunnelseTextField isReadOnly={false} isSubmittable isDirty hasBegrunnelse={false} hasVurderingText />,
    );
  ...
  it('skal vise medsendt label', () => {
    const wrapper = shallow(
      <FaktaBegrunnelseTextField isReadOnly={false} isSubmittable isDirty hasBegrunnelse={false} labelCode="Test" />,
    );
