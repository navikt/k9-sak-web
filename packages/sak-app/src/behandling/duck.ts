...
export const behandlingReducer = (state = initialState, action: Action = { type: '' }) => {
...
export const getSelectedBehandlingUuid = createSelector(
  [getBehandling],
...
export const getBehandlingType = createSelector([getBehandling], behandling =>
  behandling ? behandling.type : undefined,
);
export const getBehandlingBehandlendeEnhetId = createSelector([getBehandling], behandling =>
  behandling ? behandling.behandlendeEnhetId : undefined,
);
export const getBehandlingBehandlendeEnhetNavn = createSelector([getBehandling], behandling =>
  behandling ? behandling.behandlendeEnhetNavn : undefined,
);
export const getBehandlingSprak = createSelector([getBehandling], behandling =>
  behandling ? behandling.sprakkode : undefined,
);
...
export const getBehandlingErPapirsoknad = createSelector(
  [getBehandling],
  behandling => !!behandling && !!behandling.erAktivPapirsoknad,
);
