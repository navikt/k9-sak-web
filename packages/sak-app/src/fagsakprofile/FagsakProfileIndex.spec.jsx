...
describe('<FagsakProfileIndex>', () => {
  it('skal rendre komponent og vise alle behandlinger når ingen behandling er valgt', () => {
    ...
    const fagsakProfile = dataFetchers
      .at(0)
      .renderProp('render')({})
  ...
  it('skal omdirigere til behandling hvis flagget er satt', () => {
    ...
    const locationForBehandling = getLocationWithDefaultBehandlingspunktAndFakta({
      ...location,
    ...
    expect(redirect.at(0).props())
      .to.have.property('to')
      .that.eql(pathToBehandlingerForFagsak);
    ...
    expect(redirect.at(0).props())
      .to.have.property('to')
      .that.eql(locationForBehandling);
  });
});
