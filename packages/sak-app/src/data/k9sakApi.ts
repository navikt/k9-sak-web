...
export enum K9sakApiKeys {
  ...
  NEW_BEHANDLING_REVURDERING_FLERE_PERIODER_FRA_STEG_K9SAK = 'NEW_BEHANDLING_REVURDERING_FLERE_PERIODER_FRA_STEG_K9SAK',
...
const endpoints = new RestApiConfigBuilder()
  ...
  .withAsyncPost(
    '/k9/sak/api/behandlinger/revurder-flere-perioder-fra-steg',
