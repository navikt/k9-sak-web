...
describe('DefaultFormatter', () => {
  it('skal formatere feil der en har feilmelding i et objekt', () => {
    ...
    expect(new DefaultFormatter().format(errorData)).toEqual(ErrorMessage.withMessage(errorData.feilmelding));
  });
  ...
  it('skal formatere feil der en har message i et objekt', () => {
    ...
    expect(new DefaultFormatter().format(errorData)).toEqual(ErrorMessage.withMessage(errorData.message));
  });
