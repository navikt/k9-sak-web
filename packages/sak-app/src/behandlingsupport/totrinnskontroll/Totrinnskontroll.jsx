...
import { DataFetcher, requireProps, featureToggle, BehandlingIdentifier } from '@fpsak-frontend/fp-felles';
 ...
 */
export class Totrinnskontroll extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
const comp = requireProps(['behandlingIdentifier', 'selectedBehandlingVersjon'])(Totrinnskontroll);
