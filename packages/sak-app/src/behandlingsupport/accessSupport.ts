...
export const godkjenningsFaneAccess = (
  ...
  godkjenningsFaneAccessSelector(navAnsatt, ansvarligSaksbehandler, type)(
    navAnsatt,
    fagsakStatus,
    behandlingStatus,
    type,
...
export const sendMeldingAccess = (
  ...
  behandlingStatus: Kodeverk,
  type: Kodeverk,
) => sendMeldingAccessSelector(navAnsatt)(navAnsatt, fagsakStatus, behandlingStatus, type);
...
const allSupportPanelAccessRights = (
  ...
  godkjenningsFaneAccess: godkjenningsFaneAccess(
    navAnsatt,
    fagsakStatus,
    behandlingStatus,
