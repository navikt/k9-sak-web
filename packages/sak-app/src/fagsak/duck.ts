...
export const fagsakReducer = (state = initialState, action: Action = { type: '' }) => {
...
export const getSelectedSaksnummer = createSelector(
  [getFagsakContext],
  fagsakContext => fagsakContext.selectedSaksnummer,
);
