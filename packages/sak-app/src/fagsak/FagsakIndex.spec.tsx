...
describe('<FagsakIndex>', () => {
  it('skal rendre FagsakResolver', () => {
    const wrapper = shallow(
      <FagsakIndex harValgtBehandling selectedSaksnummer="123" alleKodeverk={{}} harVerge={false} />,
    );
  ...
  it('skal rendre modal for oppdatering av saksopplysninger', () => {
    const wrapper = shallow(
      <FagsakIndex selectedSaksnummer="123" harValgtBehandling alleKodeverk={{}} harVerge={false} />,
    );
