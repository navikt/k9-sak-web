...
const VisittkortLabels: FunctionComponent<OwnProps & WrappedComponentProps> = ({ intl, personopplysninger }) => {
    ...
    <>
      ...
      {personopplysninger.diskresjonskode === diskresjonskodeType.KODE6 && !personopplysninger.dodsdato && (
        <EtikettAdvarsel
          ...
          title={intl.formatMessage({ id: 'VisittkortLabels.Diskresjon6Tittel' })}
        >
      ...
      {personopplysninger.diskresjonskode === diskresjonskodeType.KODE7 && !personopplysninger.dodsdato && (
        <EtikettFokus
          className={styles.etikett}
          title={intl.formatMessage({ id: 'VisittkortLabels.Diskresjon7Tittel' })}
        >
