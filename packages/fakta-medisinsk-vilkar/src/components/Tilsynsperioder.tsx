        ...
        <FlexRow wrap>
          <FlexColumn>
            ...
            <TextAreaField
              ...
              aria-label={intl.formatMessage({ id: 'MedisinskVilkarForm.BehovForKontinuerligTilsynOgPleie' })}
            />
            <VerticalSpacer eightPx />
            <RadioGroupField
              ...
              readOnly={readOnly}
              direction="vertical"
              legend={<FormattedMessage id="MedisinskVilkarForm.BehovForKontinuerligTilsynOgPleie" />}
            >
          ...
          <FlexRow wrap>
            <FlexColumn>
              ...
              <TextAreaField
                ...
                validate={[required, minLength(3), maxLength(2000), hasValidText]}
                readOnly={readOnly}
                aria-label={intl.formatMessage({ id: 'MedisinskVilkarForm.SammenhengMellomSykdomOgTilsyn' })}
              />
              <VerticalSpacer eightPx />
              <RadioGroupField
                ...
                readOnly={readOnly}
                direction="vertical"
                legend={<FormattedMessage id="MedisinskVilkarForm.SammenhengMellomSykdomOgTilsyn" />}
              >
                <RadioOption
              ...
              <FlexColumn>
                ...
                <PeriodpickerField
                  ...
                  ariaLabel={intl.formatMessage({
                    id: 'MedisinskVilkarForm.BehovForKontinuerligTilsynOgPleie.Perioder',
                  })}
                />
              </FlexColumn>
              {!readOnly && (
            ...
            <FlexRow>
              <FlexColumn>
                ...
                <RadioGroupField
                  ...
                  readOnly={readOnly}
                  direction="vertical"
                  legend={<FormattedMessage id="MedisinskVilkarForm.BehovForEnEllerToOmsorgspersoner" />}
                >
                  ...
                  <>
                    ...
                    <TextAreaField
                      ...
                      aria-label={intl.formatMessage({
                        id: 'MedisinskVilkarForm.BehovForEnEllerToOmsorgspersoner',
                      })}
                    />
                  </>
                ) : null}
