        ...
        {inntekter.map(inntekt => {
          ...
          return (
            <TableRow key={key} id={key}>
              <TableColumn>{inntekt.person}</TableColumn>
              <TableColumn>{inntekt.employer}</TableColumn>
              <TableColumn>
                <PeriodLabel showTodayString dateStringFom={inntekt.fom} dateStringTom={inntekt.tom} />
              </TableColumn>
              <TableColumn>{formatCurrencyWithKr(inntekt.amount)}</TableColumn>
            </TableRow>
          );
        })}
      </Table>
...
const mapStateToProps = (state, ownProps) => ({
  inntekter: behandlingFormValueSelector(
