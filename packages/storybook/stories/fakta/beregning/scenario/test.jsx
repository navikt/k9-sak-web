...
export const beregningsgrunnlag = [
  {
    skjaeringstidspunktBeregning: '2020-04-01',
    skjæringstidspunkt: '2020-04-01',
    aktivitetStatus: [{ kode: 'AT', kodeverk: 'AKTIVITET_STATUS' }],
    beregningsgrunnlagPeriode: [
      {
        beregningsgrunnlagPeriodeFom: '2020-04-01',
        ...
        beregningsgrunnlagPrStatusOgAndel: [
          {
            dtoType: 'GENERELL',
            beregningsgrunnlagFom: '2020-01-01',
            beregningsgrunnlagTom: '2020-03-31',
            aktivitetStatus: { kode: 'AT', kodeverk: 'AKTIVITET_STATUS' },
            beregningsperiodeFom: '2020-01-01',
            beregningsperiodeTom: '2020-03-31',
            andelsnr: 1,
            inntektskategori: { kode: 'ARBEIDSTAKER', kodeverk: 'INNTEKTSKATEGORI' },
            arbeidsforhold: {
              startdato: '2020-02-03',
              opphoersdato: '2020-12-01',
    ...
    grunnbeløp: 99858.0,
    faktaOmBeregning: {
      faktaOmBeregningTilfeller: [{ kode: 'VURDER_MOTTAR_YTELSE', kodeverk: 'FAKTA_OM_BEREGNING_TILFELLE' }],
      vurderMottarYtelse: {
        erFrilans: false,
