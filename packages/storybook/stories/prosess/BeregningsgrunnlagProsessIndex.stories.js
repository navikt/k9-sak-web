...
export const tidsbegrensetArbeidsforholdMedAvvik = () => {
  const andeler = [
    ...
    lagAndel('AT', 132250, undefined, true),
    lagAndel('AT', 140250, undefined, true),
...
export const infoTrygdYtelse = () => {
  const andeler = [lagAndel('KUN_YTELSE', 360000, undefined, undefined)];
...
export const FrilansMedAvvik = () => {
  ...
  const sammenligningsgrunnlagPrStatus = [lagSammenligningsGrunnlag(sammenligningType.FL, 180000, 26.2, 11000)];
  const bg = lagBG(perioder, statuser, sammenligningsgrunnlagPrStatus);
  return (
    <BeregningsgrunnlagProsessIndex
      behandling={behandling}
...
export const arbeidstakerOgSelvstendigNæringsdrivendeUtenAkjsonspunkt = () => {
  const andeler = [lagAndel('SN', 331000, undefined, undefined, false), lagAndel('AT', 72194, undefined, undefined)];
  const pgi = lagPGIVerdier();
  andeler[0].pgiVerdier = pgi;
...
export const arbeidstakerIkkeOppfylt = () => {
  const andeler = [lagAndel('AT', 32232, undefined, undefined, false)];
