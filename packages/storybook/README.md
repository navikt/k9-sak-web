...
- Opptil flere stories med `play` er fint for å teste ulik funksjonalitet. Disse kjøres med Storybook Vitest-addon (`yarn build-storybook-test` + `yarn test-storybook`).
