...
class RequestApi extends AbstractRequestApi {
  ...
  public startRequest = (endpointName: string, params?: any, notificationMapper?: NotificationMapper) =>
    this.requestRunnersMappedByName[endpointName].startProcess(params, notificationMapper);
