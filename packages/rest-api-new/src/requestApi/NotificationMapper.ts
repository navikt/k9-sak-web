...
class NotificationMapper {
  ...
  public addRequestStartedEventHandler = (callback: EventCallback) =>
    this.addEventHandler(EventType.REQUEST_STARTED, callback);

  public addRequestFinishedEventHandler = (callback: EventCallback) =>
  ...
  public addStatusRequestStartedEventHandler = (callback: EventCallback) =>
    this.addEventHandler(EventType.STATUS_REQUEST_STARTED, callback);

  public addStatusRequestFinishedEventHandler = (callback: EventCallback) =>
    this.addEventHandler(EventType.STATUS_REQUEST_FINISHED, callback);

  public addUpdatePollingMessageEventHandler = (callback: EventCallback) =>
