...
export const historyUngsak = [
  {
    historikkinnslagUuid: '417693aa-d5da-42c7-b50b-511031eea542',
    behandlingUuid: '4cb3c38c-fe49-4548-84c5-b31687089e12',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: { kode: 'VEDTAK', kodeverk: 'SKJERMLENKE_TYPE' },
    opprettetTidspunkt: '2025-07-04T13:38:08.009698',
    dokumenter: [],
    tittel: null,
    linjer: [{ type: 'TEKST', tekst: 'Vedtak er fattet: Innvilget.' }],
  },
  {
    historikkinnslagUuid: '699cf254-91ac-4910-beec-40e422d628b5',
    behandlingUuid: '504f4e5e-c356-4203-8590-5749cde1d61b',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:08.165694',
    dokumenter: [],
    tittel: 'Revurdering opprettet',
    linjer: [{ type: 'TEKST', tekst: 'Kontroll av registerinntekt.' }],
  },
  {
    historikkinnslagUuid: '14afb2b7-14ba-461b-a6c1-b77985c9e310',
    behandlingUuid: '4cb3c38c-fe49-4548-84c5-b31687089e12',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:09.221801',
    dokumenter: [
      {
        dokumentId: '72141516',
  ...
  {
    historikkinnslagUuid: '558d5f9c-86bf-4cef-b02f-29dea8d5fb24',
    behandlingUuid: '504f4e5e-c356-4203-8590-5749cde1d61b',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:15.445501',
    dokumenter: [],
    tittel: 'Behandlingen er satt på vent til 18.07.2025',
    linjer: [{ type: 'TEKST', tekst: 'Venter på uttalelse fra bruker etter etterlysning.' }],
  },
  {
    historikkinnslagUuid: '49d4f633-8d7b-4871-84a9-bc920e180a8d',
    behandlingUuid: null,
    aktør: { type: { kode: 'SOKER', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:16.456506',
    dokumenter: [
      {
        dokumentId: '72141517',
        journalpostId: '72141517',
        tag: 'Inntektsrapportering',
        url: '',
        utgått: false,
      },
    ],
  ...
  {
    historikkinnslagUuid: '67f1ee9d-97f7-4053-9198-2a562231c310',
    behandlingUuid: '504f4e5e-c356-4203-8590-5749cde1d61b',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:16.643059',
    dokumenter: [],
    tittel: 'Behandlingen er gjenopptatt',
    linjer: [],
  },
  {
    historikkinnslagUuid: '379b7ecf-4a6d-4ce8-b6bc-24ca4a95a896',
    behandlingUuid: '504f4e5e-c356-4203-8590-5749cde1d61b',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:17.396765',
    dokumenter: [],
    tittel: 'Behandlingen er flyttet',
    linjer: [
      {
        type: 'TEKST',
        tekst: 'Behandlingen er flyttet fra Vurder kompletthet til Innhent registeropplysninger - innledende oppgaver.',
      },
    ],
  },
  {
    historikkinnslagUuid: 'dd8fe691-517b-4cb8-83fd-b6d2875ea4cd',
    behandlingUuid: '504f4e5e-c356-4203-8590-5749cde1d61b',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: { kode: 'VEDTAK', kodeverk: 'SKJERMLENKE_TYPE' },
    opprettetTidspunkt: '2025-07-04T13:38:18.596665',
    dokumenter: [],
    tittel: null,
    linjer: [{ type: 'TEKST', tekst: 'Vedtak er fattet: Innvilget.' }],
  },
  {
    historikkinnslagUuid: '027bc5e8-48c3-4f91-abc2-517f54d16651',
    behandlingUuid: '504f4e5e-c356-4203-8590-5749cde1d61b',
    aktør: { type: { kode: 'VL', kodeverk: 'HISTORIKK_AKTOER' }, ident: null },
    skjermlenke: null,
    opprettetTidspunkt: '2025-07-04T13:38:20.333888',
    dokumenter: [
      {
        dokumentId: '72141518',
    ...
    tittel: 'Vedtaksbrev bestilt',
    linjer: [{ type: 'TEKST', tekst: 'Endring av inntekt.' }],
  },
];
