...
describe('<MeldingIndex>', () => {
  ...
  it('skal sette default tom streng ved forhåndsvisning dersom fritekst ikke er fylt ut', async () => {
    requestApi.mock(UngSakApiKeys.PREVIEW_MESSAGE_FORMIDLING, {});
    ...
    const reqData = requestApi.getRequestMockData(UngSakApiKeys.PREVIEW_MESSAGE_FORMIDLING);
  ...
  it('skal sende melding', async () => {
    ...
    const reqData = requestApi.getRequestMockData(UngSakApiKeys.SUBMIT_MESSAGE);
    expect(reqData).toHaveLength(1);
