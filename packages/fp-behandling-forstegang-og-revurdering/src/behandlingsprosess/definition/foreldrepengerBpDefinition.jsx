...
const foreldrepengerBuilders = [
  new BehandlingspunktProperties.Builder(bpc.SAKSOPPLYSNINGER, 'Saksopplysninger').withAksjonspunktCodes(
    ac.AVKLAR_PERSONSTATUS,
  ),
  ...
  new BehandlingspunktProperties.Builder(bpc.FOEDSEL, 'Fodselsvilkaret')
    ...
    .withAksjonspunktCodes(
      ac.OVERSTYR_FODSELSVILKAR,
      ac.OVERSTYR_FODSELSVILKAR_FAR_MEDMOR,
  ...
  new BehandlingspunktProperties.Builder(bpc.ADOPSJON, 'Adopsjonsvilkaret')
    ...
    .withAksjonspunktCodes(
      ac.OVERSTYRING_AV_ADOPSJONSVILKÅRET_FP,
      ac.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,
      ac.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN,
    ),
  ...
  new BehandlingspunktProperties.Builder(bpc.OPPTJENING, 'Opptjeningsvilkaret')
    ...
    .withAksjonspunktCodes(ac.OVERSTYRING_AV_OPPTJENINGSVILKARET, ac.VURDER_OPPTJENINGSVILKARET),
  ...
  new BehandlingspunktProperties.Builder(bpc.SOEKNADSFRIST, 'Soknadsfristvilkaret').withAksjonspunktCodes(
    ac.VURDER_SOKNADSFRIST_FORELDREPENGER,
  ),
...
const createForeldrepengerBpProps = builderData =>
  foreldrepengerBuilders.reduce((currentFbs, fb) => {
