...
describe('behandlingsprosessForstegangOgRevSelectors', () => {
  // FIXME kommentert ut da denne ikke er aktuell for pleiepenger
  xit('skal opprette default behandlingspunkter og for aksjonspunkt varsel revurdering for engangsstønad', () => {
    ...
    const bpProps = getBehandlingspunkterProps.resultFunc(
      fagsakYtelseType,
      behandlingType,
      vilkar,
      aksjonspunkter,
