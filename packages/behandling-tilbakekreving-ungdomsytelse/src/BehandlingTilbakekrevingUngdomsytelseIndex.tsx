...
import { pollingClient } from '@k9-sak-web/backend/ungtilbake/pollingClient.js';
...
const BehandlingTilbakekrevingUngdomsytelseIndex = ({
  ...
  return (
    <>
      ...
      />
      <BehandlingProvider behandling={behandling} refetchBehandling={() => hentBehandling(behandlingUuid, true)} setBehandling={setBehandling} pollingClient={pollingClient}>
