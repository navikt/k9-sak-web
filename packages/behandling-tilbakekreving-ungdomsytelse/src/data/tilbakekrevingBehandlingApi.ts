...
const endpoints = new RestApiConfigBuilder()
  .withAsyncPost('/ung/tilbake/api/behandlinger', TilbakekrevingBehandlingApiKeys.BEHANDLING_TILBAKE)
  .withGet('/ung/tilbake/api/kodeverk', TilbakekrevingBehandlingApiKeys.TILBAKE_KODEVERK)
  ...
  /* FPFORMIDLING */
  .withPost('/ung/tilbake/api/dokument/forhandsvis-vedtaksbrev', TilbakekrevingBehandlingApiKeys.PREVIEW_VEDTAKSBREV, {
    isResponseBlob: true,
  })
  .withPost('/ung/formidling/api/brev/html', TilbakekrevingBehandlingApiKeys.HENT_FRITEKSTBREV_HTML)
