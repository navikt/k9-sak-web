...
describe('<GrunnlagForAarsinntektPanelFL>', () => {
  it('Skal teste tabellen får korrekt antall rader UTEN arbeidsforhold startdato', () => {
    ...
    const ledeText = rows.at(1).find('MemoizedFormattedMessage');
    ...
    expect(mndAndelFL.at(1).childAt(0).text()).to.equal(
      formatCurrencyNoKr(periode.beregningsgrunnlagPrStatusOgAndel[0].beregnetPrAar / 12),
    );
