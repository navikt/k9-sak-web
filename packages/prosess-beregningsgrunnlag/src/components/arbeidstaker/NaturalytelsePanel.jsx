...
const createOrEditMapValue = (
  andel,
  arbeidsgiverOpplysningerPerId,
  mapValue,
  antallPerioderMedFrafaltYtelse,
  periodeTekst,
) => {
  let newMapValue = [];
...
export const createNaturalytelseTableData = (allePerioder, arbeidsgiverOpplysningerPerId) => {
  ...
  relevantePerioder.forEach(periode => {
    ...
    andelerMedFrafaltYtelse.forEach(andel => {
      ...
      tempMap[mapKey] = createOrEditMapValue(
        andel,
        arbeidsgiverOpplysningerPerId,
        mapValue,
        antallPerioderMedFrafaltYtelse,
 ...
 */
const NaturalytelsePanel = ({ allePerioder, arbeidsgiverOpplysningerPerId }) => {
