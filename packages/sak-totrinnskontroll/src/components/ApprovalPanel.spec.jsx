...
describe('<ApprovalPanel>', () => {
  ...
  const getTilbakekrevingsSkjermlenkeContexts = () => [
    {
      ...
      totrinnskontrollAksjonspunkter: [createAksjonspunkt(aksjonspunktCodesTilbakekreving.VURDER_TILBAKEKREVING)],
    },
    {
      skjermlenkeType: 'FORELDELSE',
      totrinnskontrollAksjonspunkter: [createAksjonspunkt(aksjonspunktCodesTilbakekreving.VURDER_FORELDELSE)],
    },
    {
      skjermlenkeType: 'VEDTAK',
      totrinnskontrollAksjonspunkter: [createAksjonspunkt(aksjonspunktCodesTilbakekreving.FORESLA_VEDTAK)],
    },
    {
  ...
  it('skal mappe aksjonspunkter til context-objekt når aksjonspunkter hentes frå rest-tjeneste', () => {
    ...
    expect(medlemskapContext[0].aksjonspunkter).to.have.length(4);
  ...
  it('skal vise sorterte approvals for tilbakekrevingsbehandling', () => {
    ...
    const approvals = wrapper.state('approvals');
    expect(approvals).to.have.length(4);
