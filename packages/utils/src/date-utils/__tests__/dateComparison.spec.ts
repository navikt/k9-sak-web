  ...
  describe('isSameOrBefore', () => {
    ...
    describe('with mixed date formats', () => {
      ...
      it('handles dayjs object and string date together', () => {
        const dayjsDate = dayjs('2025-07-01');
