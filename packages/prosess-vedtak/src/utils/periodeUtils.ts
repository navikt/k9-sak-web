 ...
 */
export const sorterOverlappendePerioder = (perioder: Periode<OverlappendePeriode>[]) =>
 ...
 */
export const sorterOverlappendeRader = (rader: TidslinjeRad<OverlappendePeriode>[]) =>
