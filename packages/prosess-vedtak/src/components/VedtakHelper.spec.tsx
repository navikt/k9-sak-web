...
import { BehandlingResultatType as klageBehandlingsresultat } from '@k9-sak-web/backend/combined/kodeverk/behandling/BehandlingResultatType.js';
import { fagsakYtelsesType } from '@k9-sak-web/backend/k9sak/kodeverk/FagsakYtelsesType.js';
import type { AvslagsårsakPrPeriodeDto } from '@k9-sak-web/backend/k9sak/kontrakt/AvslagsårsakPrPeriodeDto.js';
import { AvslagsårsakPrPeriodeDtoAvslagsårsak } from '@k9-sak-web/backend/k9sak/kontrakt/AvslagsårsakPrPeriodeDtoAvslagsårsak.js';
...
import { TilbakekrevingVidereBehandling as TilbakekrevingValgDtoVidereBehandling } from '@k9-sak-web/backend/k9sak/kodeverk/økonomi/tilbakekreving/TilbakekrevingVidereBehandling.js';
import {
