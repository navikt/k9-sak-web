  ...
  return (
    <div className={styles.utenlandsopphold}>
      ...
      <Alert variant="info" className={styles.alertstripe}>
        <Ekspanderbartpanel
          tittel="Hvor lenge har søker rett på opplaeringspenger i utlandet?"
        ...
        >
          <ul>
            <li>
              ...
              kan motta opplaeringspenger.
            </li>
            <li>
              For opphold utenfor EØS skal perioden med opplaeringspenger i utgangspunktet begrenses til 8 uker i løpet
            ...
            <li>Vilkårene for rett til opplaeringspenger må være oppfylt hele perioden.</li>
            <li>
              Det utbetales ikke opplaeringspenger når søker avvikler ferie. Utenlandsopphold i en periode med ferie
              telles derfor ikke med, uavhengig av årsaken til utenlandsoppholdet.
            </li>
          </ul>
        </Ekspanderbartpanel>
      </Alert>
