import arrowLeftPurpleImageUrl from '@k9-sak-web/assets/images/arrow_left_purple.svg';
import eksternLinkImageUrl from '@k9-sak-web/assets/images/ekstern_link_pil_boks.svg';
...
import { DateTimeLabel, Image, Tooltip } from '@k9-sak-web/shared-components';
