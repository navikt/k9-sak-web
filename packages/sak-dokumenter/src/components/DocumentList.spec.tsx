...
describe('<DocumentList>', () => {
  it('skal vise to dokumenter i liste', () => {
    ...
    expect(tableColumnsRow1.at(1).html()).toEqual(
      '<td class="columnStyle"><a href="/k9/sak/api/dokument/hent-dokument?saksnummer=1&amp;journalpostId=1&amp;dokumentId=1" target="_blank" rel="noopener noreferrer" class="documentAnchor"><span class="typo-normal">Terminbekreftelse</span></a></td>',
    );
    ...
    expect(tableColumnsRow2.at(1).html()).toEqual(
      '<td class="columnStyle"><a href="/k9/sak/api/dokument/hent-dokument?saksnummer=1&amp;journalpostId=2&amp;dokumentId=2" target="_blank" rel="noopener noreferrer" class="documentAnchor"><span class="typo-normal">Førstegangssøknad</span></a></td>',
    );
  });
