class MenyBehandlingData {
  ...
  constructor(id, uuid, versjon, type, erPaVent, erKoet, behandlendeEnhetId, behandlendeEnhetNavn, kanHenlegge) {
    this.$$id = id;
    this.$$uuid = uuid;
