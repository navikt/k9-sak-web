...
export function ProsessDefaultInitPanel({
  ...
  // Registrer panel
  // Dette skjer alltid, selv om panelet ikke er synlig, slik at menyen
  // kan vise panelet som deaktivert hvis ønskelig senere
  ...
  // Hvis panelet ikke skal vises, returner null
  if (!erSynlig) {
    return null;
  }
