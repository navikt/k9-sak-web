...
export function useProsessMenyToggle(): UseProsessMenyToggleResult {
    ...
    const v2Enabled = featureToggles?.PROSESS_MENY_V2 ?? false;
    const velgerEnabled = featureToggles?.PROSESS_MENY_V2_VELGER ?? false;
    ...
    const ToggleComponent = v2Enabled && velgerEnabled ? (
        <HStack
            align="center"
            gap="2"
            justify="center"
