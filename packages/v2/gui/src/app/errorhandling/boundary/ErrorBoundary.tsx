...
export interface ErrorBoundaryProps {
  ...
  // If set, the ErrorBoundary will only report error and call this callback, not display error itself. May be combined with errorFallback.
...
export class ErrorBoundary extends Component<ErrorBoundaryProps, State> {
  ...
  override componentDidCatch(): void {
    ...
    if (error != null) {
      // Viss filter er sett og returnerer false, ikkje kall callback — feilen blir kasta vidare i render()
