...
import { useFeatureToggles } from '../featuretoggles/useFeatureToggles.ts';
  ...
  useEffect(() => {
    ...
    const listener = (event: PromiseRejectionEvent) => {
      ...
      if (isErrorWithAlertInfo(error)) {
        ...
        // Tester å vise alle slike når featureToggle er på:
      } else if (featureToggles?.VIS_ALLE_UNHANDLED_REJECTIONS && error instanceof Error) {
