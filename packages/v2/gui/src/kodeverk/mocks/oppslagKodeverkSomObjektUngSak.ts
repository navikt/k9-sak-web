...
export const oppslagKodeverkSomObjektUngSak = {
  ...
  skjermlenkeTyper: [
    ...
    {
      kode: 'FORMKRAV_KLAGE_VEDTAKSINSTANS',
      kodeverk: 'SKJERMLENKE_TYPE',
      navn: 'Formkrav klage Vedtaksinstans',
      kilde: 'FORMKRAV_KLAGE_VEDTAKSINSTANS',
    },
    {
      kode: 'KLAGE_BEH_VEDTAKSINSTANS',
      kodeverk: 'SKJERMLENKE_TYPE',
      navn: 'Klageresultat Vedtaksinstans',
      kilde: 'KLAGE_BEH_VEDTAKSINSTANS',
    },
    {
  ...
  klagevurderingType: [
    ...
    {
      kode: 'HJEMSENDE_UTEN_Å_OPPHEVE',
      kodeverk: 'KLAGEVURDERING',
      navn: 'Hjemsende uten å oppheve',
      kilde: 'HJEMSENDE_UTEN_Å_OPPHEVE',
    },
    {
    ...
    {
      kode: 'OPPHEVE_YTELSESVEDTAK',
      kodeverk: 'KLAGEVURDERING',
      navn: 'Ytelsesvedtaket oppheves',
      kilde: 'OPPHEVE_YTELSESVEDTAK',
    },
    {
      kode: 'STADFESTE_YTELSESVEDTAK',
      kodeverk: 'KLAGEVURDERING',
      navn: 'Ytelsesvedtaket stadfestes',
      kilde: 'STADFESTE_YTELSESVEDTAK',
    },
    {
      kode: 'TRUKKET_KLAGE',
      kodeverk: 'KLAGEVURDERING',
