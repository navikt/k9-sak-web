 ...
 */
export class FailingUngTilbakeKodeverkoppslag extends UngTilbakeKodeverkoppslag {
  constructor() {
    super({} as EO);
  }

  override finnObjektFraKilde(kodeverk: keyof EO, kode: string): never {
    throw new Error(`UngTilbakeKodeverkoppslag er ikke initialisert. Kan ikke slå opp ${kodeverk} med kode ${kode}.`);
  }
}
