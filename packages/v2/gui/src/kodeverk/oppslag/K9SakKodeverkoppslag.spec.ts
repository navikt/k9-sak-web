...
import { AndelForFaktaOmBeregningDtoAktivitetStatus } from '@k9-sak-web/backend/k9sak/kodeverk/beregning/AndelForFaktaOmBeregningDtoAktivitetStatus.js';
import type { AktivitetStatus } from '@k9-sak-web/backend/k9sak/tjenester/kodeverk/dto/AktivitetStatus.js';
