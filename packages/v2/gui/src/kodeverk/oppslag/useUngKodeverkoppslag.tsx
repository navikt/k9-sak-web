...
import { hentKodeverk as ungsak_kodeverk_alleKodeverdierSomObjekt } from '@k9-sak-web/backend/ungsak/sdk.js';
import { hentKodeverk as ungtilbake_kodeverk_alleKodeverdierSomObjekt } from '@k9-sak-web/backend/ungtilbake/sdk.js';
