import type { k9_sak_kontrakt_vedtak_TotrinnskontrollSkjermlenkeContextDto as TotrinnskontrollSkjermlenkeContextDto } from '@navikt/k9-sak-typescript-client';
