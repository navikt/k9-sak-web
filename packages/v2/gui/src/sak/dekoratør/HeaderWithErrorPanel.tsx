...
const HeaderWithErrorPanel = ({
  ...
  return (
    <div ref={fixedHeaderRef} className={`${styles.container} ${isInDevelopmentMode() ? styles.containerDev : ''}`}>
      <div ref={wrapperRef}>
        <Header title={ytelse} titleHref={getHeaderTitleHref(getPathToLos, headerTitleHref)}>
          <>
            {/*
