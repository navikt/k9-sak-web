...
type PgiÅrsinntekt = BeregningsgrunnlagDto['pgiÅrsinntekter'][number];

const AktivitetspengerBeregningsgrunnlag = ({ data }: Props) => {
  ...
  const sortertePgiÅrsinntekter = data.pgiÅrsinntekter.toSorted(
    (a: PgiÅrsinntekt, b: PgiÅrsinntekt) => b.årstall - a.årstall,
  );
          ...
          {sortertePgiÅrsinntekter.length > 0 && (
            ...
            >
              <Table>
                ...
                <Table.Body>
                  {sortertePgiÅrsinntekter.map((pgi: PgiÅrsinntekt, index: number) => {
...
export default AktivitetspengerBeregningsgrunnlag;
