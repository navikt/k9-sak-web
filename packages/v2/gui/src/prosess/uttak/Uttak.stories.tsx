...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Hovedkomponent for uttak som håndterer uttaksperioder og vurderinger. '
      },
    },
  },
  decorators: [
  ...
  args: {
    ...
    uttak: lagUttak([
      ...
      lagIkkeOppfyltPeriode(
        ...
        [Årsak.FOR_LAV_TAPT_ARBEIDSTID, Årsak.AVKORTET_MOT_INNTEKT],
        {
          uttaksgrad: 0,
...
export const UttakGradertMotInntekt: Story = {
  ...
  args: {
    ...
    uttak: lagUttak([
      ...
      lagInntektsgraderingPeriode('2024-01-01/2024-01-15', 70, [
        { orgnr: '123456789', utbetalingsgrad: 70 },
      ]),
