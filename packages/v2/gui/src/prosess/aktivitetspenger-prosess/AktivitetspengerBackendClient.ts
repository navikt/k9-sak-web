...
export class AktivitetspengerBackendClient implements AktivitetspengerApi {
  ...
  async hentMedlemskapFraSøknad(behandlingUuid: string) {
    // TODO(TSFF-3050): ung-sak#1603 (ny medlemskapskontrakt) er ikke sluppet ennå, så den
    // genererte SDK-typen har fortsatt gammel kontraktform. Fjern denne casten når
    // @navikt/ung-sak-typescript-client er oppdatert med de nye typene.
