import { OpplæringVurderingDtoAvslagsårsak, OpplæringVurderingDtoResultat } from '@k9-sak-web/backend/k9sak/generated';
        ...
        return (
          ...
          >
            <Radio value={KodeverdiSomObjektAvslagsårsakKilde.IKKE_NØDVENDIG_OPPLÆRING}>
              {
                (k9Kodeverkoppslag as any).k9sak.avslagsårsaker(
