...
describe('createQueryClient', () => {
  it('should return expected default options when called without argument', () => {
    ...
    expect(opts.queries).toEqual({ throwOnError: true, refetchOnWindowFocus: false });
  ...
  it('should return default queries options, plus queries override when called with argument', () => {
    ...
    expect(opts.queries).toEqual({ throwOnError: true, refetchOnWindowFocus: false, retry: false });
  });
  it('should override default options set when called with argument', () => {
    ...
    expect(opts.queries).toEqual({ throwOnError: true, refetchOnWindowFocus: true });
  });
