...
const getArrowBoxTopCss = (alignOffset: number, marginTop: number, marginLeft: number) => `
...
const getArrowBoxLeftCss = (alignOffset: number, marginTop: number, marginLeft: number) => `
...
`;
const getArrowBox = (alignOffset: number, alignLeft: boolean, marginTop: number, marginLeft: number) =>
  alignLeft
    ? getArrowBoxLeftCss(alignOffset, marginTop, marginLeft)
    : getArrowBoxTopCss(alignOffset, marginTop, marginLeft);

const getClassName = (alignOffset: number, alignLeft: boolean, hideBorder: boolean) => {
  if (hideBorder) {
    return '';
  }
