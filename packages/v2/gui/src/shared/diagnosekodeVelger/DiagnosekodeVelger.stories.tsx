...
import { withFormProvider } from '../../storybook/decorators/withFormProvider.tsx';
...
// Deklarefer datatypen DiagnosekodeVelger bruker i useForm
...
export const Standard: Story = {
  ...
  decorators: withFormProvider<FormValues>('diagnosekodevelger', emptyFormProps),
  play: async ({ loaded }) => {
    ...
    const {
      ...
      getValues,
    }: UseFormReturn<FormValues> = loaded['diagnosekodevelger'];
...
export const MedUtfylteDiagnosekoder: Story = {
  args: { ...Standard.args },
  decorators: withFormProvider('diagnosekodevelger', { defaultValues: { diagnosekoder: ['A001', 'B002'] } }),
  play: async ({ loaded, canvas, step }) => {
    const submitBtn = canvas.getByTestId(`diagnosekodevelger-Submit`);
...
export const Valideringsfeil: Story = {
  args: { ...Standard.args },
  decorators: withFormProvider('diagnosekodevelger', emptyFormProps),
