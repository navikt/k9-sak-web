...
const BehandlingUngdomsytelseIndex = ({
  ...
  return (
    <>
      ...
      />
      <BehandlingProvider behandling={behandling} refetchBehandling={() => hentBehandling({ behandlingId }, true)} setBehandling={setBehandling} aksjonspunktClient={ungSakAksjonspunktClient}>
