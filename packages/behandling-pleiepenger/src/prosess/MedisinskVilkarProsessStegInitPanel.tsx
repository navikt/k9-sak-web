...
const RELEVANTE_VILKAR_KODER = [
  k9_kodeverk_vilkår_VilkårType.MEDISINSKEVILKÅR_UNDER_18_ÅR,
  k9_kodeverk_vilkår_VilkårType.MEDISINSKEVILKÅR_18_ÅR,
];
...
const transformerTilPerioder = (vilkår: k9_sak_kontrakt_vilkår_VilkårMedPerioderDto[]) => {
  const vilkårUnder18 = vilkår.find(v => v.vilkarType === k9_kodeverk_vilkår_VilkårType.MEDISINSKEVILKÅR_UNDER_18_ÅR);
  const vilkårOver18 = vilkår.find(v => v.vilkarType === k9_kodeverk_vilkår_VilkårType.MEDISINSKEVILKÅR_18_ÅR);
