...
export const fastsettATLIntersection = tilfeller =>
  vurderOgFastsettATFLTilfeller.filter(tilfelle => tilfeller.includes(tilfelle));

const harLonnsendringOgNyoppstartet = tilfeller =>
...
const harIkkeLonnsendringEllerNyoppstartet = tilfeller =>
  !(
    tilfeller.includes(faktaOmBeregningTilfelle.VURDER_LONNSENDRING) ||
    tilfeller.includes(faktaOmBeregningTilfelle.VURDER_NYOPPSTARTET_FL)
  );
...
export const harKunATFLISammeOrg = tilfeller =>
...
const harLonnsendringNyOppstartetFLOgATFLISammeOrg = tilfeller =>
...
export const erATFLSpesialtilfelleEllerVurderMottarYtelse = tilfeller =>
  erATFLSpesialtilfelle(tilfeller) || harVurderMottarYtelse(tilfeller);

export const harIkkeATFLSameOrg = tilfeller =>
  !tilfeller.includes(faktaOmBeregningTilfelle.VURDER_AT_OG_FL_I_SAMME_ORGANISASJON);
