...
const harAvklaringsbehov = (avklaringsbehovCode: string, avklaringsbehov: BeregningAvklaringsbehov[]): boolean =>
...
const isBGAksjonspunktSomGirFritekstfelt = avklaringsbehovIsOfType(
  beregningsgrunnlagFritekstfeltIVedtakAksjonspunkt,
);

const isBeregningAvklaringsbehov = avklaringsbehovIsOfType(løsesIBeregningspunkt);
