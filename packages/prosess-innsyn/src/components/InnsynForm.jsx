...
const hentDokumenterMedNavnOgFikkInnsyn = dokumenter =>
  dokumenter.reduce((acc, d) => {
...
const getDocumentsStatus = (values, documents) =>
...
const mapStateToPropsFactory = (initialState, initialOwnProps) => {
  ...
  return (state, ownProps) => ({
    ...
    )(state, 'innsynResultatType'),
    sattPaVent: behandlingFormValueSelector(
      formName,
      ownProps.behandlingId,
      ownProps.behandlingVersjon,
    )(state, 'sattPaVent'),
