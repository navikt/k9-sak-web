...
const getPaVentText = (hasManualPaVent, frist) =>
  hasManualPaVent || frist ? 'SettBehandlingPaVentModal.ErPaVent' : 'SettBehandlingPaVentModal.ErPaVentUtenFrist';
          ...
          <Row>
            <Column xs="1">
              <Image
                ...
                alt={intl.formatMessage({ id: 'SettBehandlingPaVentModal.PaVent' })}
            ...
            {(hasManualPaVent || frist) && (
              <Column xs="2">
                <div className={styles.datePicker}>
                  <DatepickerField name="frist" validate={[required, hasValidDate]} />
                </div>
              </Column>
            )}
          </Row>
            ...
            <Column>
              ...
              {(!hasManualPaVent || showAvbryt) && (
                <Knapp htmlType="button" mini onClick={cancelEvent} className={styles.cancelButton}>
                  {intl.formatMessage({
                    id: hasManualPaVent ? 'SettBehandlingPaVentModal.Avbryt' : 'SettBehandlingPaVentModal.Lukk',
                  })}
                </Knapp>
              )}
            </Column>
