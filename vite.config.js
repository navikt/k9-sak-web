...
export default ({ mode }) => {
  ...
  return defineConfig({
    ...
    test: {
      deps: {
        inline: ['@navikt/k9-sak-typescript-client', '@navikt/k9-klage-typescript-client'], // Without this, tests using k9-sak-typescript-client through backend project failed.
        interopDefault: true
      },
      environment: 'jsdom',
      css: {
