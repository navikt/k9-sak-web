...
| Task                                                                          | Route                                                                                                                                                                                                                         |
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Build / refactor Aksel UI (components, forms, layout, styling, theming, a11y) | **Load the `aksel-spacing` skill** and follow its decision tree (`aksel_find_docs` → `aksel_get_component_info` / `aksel_get_doc` → build → validate).                                                                        |
