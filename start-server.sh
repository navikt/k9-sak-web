...
[ -d /usr/share/nginx/html/feature-toggle ] && echo "Feature toggle-directory finnes fra før, tilbakestiller" && rm -r /usr/share/nginx/html/feature-toggle/* || mkdir  /usr/share/nginx/html/feature-toggle
envsubst < /etc/nginx/conf.d/feature-toggles.json > /usr/share/nginx/html/feature-toggle/toggles.json
...
cat /usr/share/nginx/html/feature-toggle/toggles.json
